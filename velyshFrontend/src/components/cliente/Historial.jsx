...
export default function Historial() {
  ...
  const [modalDevolucion, setModalDevolucion]  = useState(null) // { id_pedido, id_detalle }
  const [motivo,          setMotivo]           = useState("")
  const [enviandoDev,     setEnviandoDev]      = useState(false)
  const [errorDev,        setErrorDev]         = useState("")
  const [devolucionesEnviadas, setDevolucionesEnviadas] = useState([]) // ids de detalle ya solicitados en esta sesión
